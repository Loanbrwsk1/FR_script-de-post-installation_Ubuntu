...
app_to_install="screen htop nmon glances neofetch screenfetch inxi nvtop ncdu cronie sl nyancat nwipe ecryptfs-utils nmap iftop traceroute telnet borgbackup soundconverter virtualbox cool-retro-term gparted"
